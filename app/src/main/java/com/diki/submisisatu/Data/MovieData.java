...
public class MovieData {
    public static  String[] [] data = new String[][]{
            {
                "Zack and Miri Make a Porno",
                    "Romance",
                    "https://image.tmdb.org/t/p/w300_and_h450_bestv2//zxwEJBhSSu5AuKTTd4ugWaCqmg.jpg",
            ...
            ,
            {
                "Youth in Revolt",
                    "Comedy",
                    "https://upload.wikimedia.org/wikipedia/en/thumb/9/94/Youth_in_Revolt_Poster.jpg/220px-Youth_in_Revolt_Poster.jpg",
                    ...
                    "7.2"},
            {
                "You Will Meet a Tall Dark Stranger\n",
                    "Comedy\n",
                    "https://upload.wikimedia.org/wikipedia/en/thumb/6/61/You_will_meet_a_tall_dark_stranger_ver3.jpg/220px-You_will_meet_a_tall_dark_stranger_ver3.jpg",
                    ...
                    "7.2"},
            {
                "What Happens in Vegas\n",
                    "Comedy\n",
                    "https://upload.wikimedia.org/wikipedia/en/thumb/2/23/What_happens_in_vegas.jpg/220px-What_happens_in_vegas.jpg",
                    ...
                    "7.2"},
            {
                "When in Rome",
                    "Comedy",
                    "https://images-na.ssl-images-amazon.com/images/I/51vKjdEvZYL._SY445_.jpg",
                    ...
                    "7.2"},
            {
                "Water For Elephants\n",
                    "Drama\n",
                    "https://images-na.ssl-images-amazon.com/images/I/91s849Pw2kL._SY445_.jpg",
                    ...
                    "7.2"},
            {
                "WALL-E\n",
                    "Animation\n",
                    "https://images.store.sky.com/api/img/asset/en/66D8BB8A-E4E8-4422-9242-603110084545_D1530AB1-81DA-42F2-9425-21F36C9BA9EC_2018-11-27-T15-46-5.jpg?s=260x371",
            ...
            ,
            {
                    "Waitress\n",
                    "Romance\n",
                    "https://upload.wikimedia.org/wikipedia/en/thumb/c/c7/Waitress_musical_Broadway_poster.jpg/220px-Waitress_musical_Broadway_poster.jpg",
            ...
            ,
            {
                    "Waiting For Forever\n",
                    "Romance\n",
                    "https://images-na.ssl-images-amazon.com/images/I/91cyXUJZF7L._SY445_.jpg",
            ...
            ,
            {
                    "Valentine's Day\n",
                    "Comedy\n",
                    "https://www.ralphs.com/content/v2/binary/image/featured/valentines-day-galentines-shop/vday_category-desktop-1547874880884.jpg",
            ...
            ,
            {
                    "The Ugly Truth\n",
                    "Comedy\n",
                    "https://upload.wikimedia.org/wikipedia/en/thumb/a/ad/Ugly_truth.jpg/220px-Ugly_truth.jpg",
    ...
    public static ArrayList<Movie> getListData(){
      ...
      for (String[] aData : data){
          ...
          movie.setDeskripsi(aData[3]);
          movie.setRealese(aData[4]);
          movie.setPruduksi(aData[5]);
          movie.setIncome(aData[6]);
          movie.setRating(aData[7]);
          list.add(movie);
      }
      return list;
    }
